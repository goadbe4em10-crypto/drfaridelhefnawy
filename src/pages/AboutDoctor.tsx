...
const qualifications = [
  "دكتوراه جراحة المخ والأعصاب",
  "زمالة جراحة المخ والأعصاب الوظيفية",
  "عضو الجمعية المصرية لجراحة المخ والأعصاب",
  "عضو الجمعية العالمية لجراحة المخ والأعصاب الوظيفية",
];
